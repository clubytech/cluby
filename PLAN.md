...
Alchemy-ключ для Robinhood Chain — **есть**, archive проверен. Ключ деплоера с 0.03 ETH на 4663 — **есть** (`0x9C5C4b4A985b0A60a1067a0d82020774661d074A`, горячий, только деплой). $150 USDG для первого депозита — открыто. Safe 2-из-3 — скрипт `contracts/script/deploy-safe.sh` готов, ждёт три адреса владельцев.

**Решение по токену (2026-09-04): лаунч через PONS — ПОСЛЕ первых рынков.** Причина: у PONS нет Chainlink-фида на 4663, он ценится только TWAP своего пула, и этот же пул — единственный оракул для рынка PONS в каталоге. Лаунч до запуска рынков двигал бы цену собственного оракула. Сначала Chainlink-рынки (NVDA/SPY/AAPL/MSFT), они от пулов не зависят.
